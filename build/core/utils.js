...
const genEpochKey = (identityNullifier, epoch, nonce, _epochTreeDepth = config_1.EPOCH_TREE_DEPTH) => {
    const values = [
        identityNullifier,
        epoch,
        nonce,
...
const verifyEpochKeyProofEvent = async (event) => {
    var _a;
    const args = (_a = event === null || event === void 0 ? void 0 : event.args) === null || _a === void 0 ? void 0 : _a.proof;
    const emptyArray = [];
...
const verifyStartTransitionProofEvent = async (event) => {
    ...
    const emptyArray = [];
    const formatPublicSignals = emptyArray
        .concat(args === null || args === void 0 ? void 0 : args.blindedUserState, args === null || args === void 0 ? void 0 : args.blindedHashChain, args === null || args === void 0 ? void 0 : args.globalStateTree)
        .map((n) => BigInt(n));
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(args === null || args === void 0 ? void 0 : args.proof);
...
const verifyProcessAttestationEvent = async (event) => {
    ...
    const emptyArray = [];
    const formatPublicSignals = emptyArray
        .concat(args === null || args === void 0 ? void 0 : args.outputBlindedUserState, args === null || args === void 0 ? void 0 : args.outputBlindedHashChain, args === null || args === void 0 ? void 0 : args.inputBlindedUserState)
        .map((n) => BigInt(n));
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(args === null || args === void 0 ? void 0 : args.proof);
...
const verifyUserStateTransitionEvent = async (event) => {
    var _a;
    const transitionArgs = (_a = event === null || event === void 0 ? void 0 : event.args) === null || _a === void 0 ? void 0 : _a.proof;
    const emptyArray = [];
...
const verifyUSTEvents = async (transitionEvent, startTransitionEvent, processAttestationEvents) => {
    ...
    const transitionArgs = (_a = transitionEvent === null || transitionEvent === void 0 ? void 0 : transitionEvent.args) === null || _a === void 0 ? void 0 : _a.proof;
...
const verifyProcessAttestationEvents = async (processAttestationEvents, startBlindedUserState, finalBlindedUserState) => {
    ...
    for (let i = 0; i < processAttestationEvents.length; i++) {
        ...
        if (!isValid)
            return false;
        currentBlindedUserState = args === null || args === void 0 ? void 0 : args.outputBlindedUserState;
    }
...
const genUnirepStateFromContract = async (provider, address, _unirepState) => {
    ...
    for (const event of events) {
        const proofIndex = Number((_a = event === null || event === void 0 ? void 0 : event.args) === null || _a === void 0 ? void 0 : _a.proofIndex);
    ...
    for (let i = 0; i < sequencerEvents.length; i++) {
        ...
        if (blockNumber < startBlock)
            continue;
        const occurredEvent = (_b = sequencerEvent.args) === null || _b === void 0 ? void 0 : _b.userEvent;
        if (occurredEvent === contracts_1.Event.UserSignedUp) {
            ...
            const epoch = Number(args === null || args === void 0 ? void 0 : args.epoch);
            const commitment = BigInt(args === null || args === void 0 ? void 0 : args.identityCommitment);
            const attesterId = Number(args === null || args === void 0 ? void 0 : args.attesterId);
            const airdrop = Number(args === null || args === void 0 ? void 0 : args.airdropAmount);
            ...
            const attestation_ = args === null || args === void 0 ? void 0 : args.attestation;
            const event = proofIndexMap[toProofIndex];
            const results = (_c = event === null || event === void 0 ? void 0 : event.args) === null || _c === void 0 ? void 0 : _c.proof;
            if (isProofIndexValid[toProofIndex] === undefined) {
                ...
                if ((args === null || args === void 0 ? void 0 : args.attestationEvent) === contracts_1.AttestationEvent.SpendReputation) {
            ...
            if (fromProofIndex && isProofIndexValid[fromProofIndex]) {
                ...
                const proveReputationAmount = Number((_e = (_d = fromEvent === null || fromEvent === void 0 ? void 0 : fromEvent.args) === null || _d === void 0 ? void 0 : _d.proof) === null || _e === void 0 ? void 0 : _e.proveReputationAmount);
            ...
            if (isProofIndexValid[toProofIndex] &&
                ...
                const epochKey = args === null || args === void 0 ? void 0 : args.epochKey;
            ...
            const epoch = (_f = epochEndedEvent.args) === null || _f === void 0 ? void 0 : _f.epoch.toNumber();
            ...
            const epoch = Number(args === null || args === void 0 ? void 0 : args.epoch);
            const newLeaf = BigInt(args === null || args === void 0 ? void 0 : args.hashedLeaf);
            const proofIndex = Number(args === null || args === void 0 ? void 0 : args.proofIndex);
            const event = proofIndexMap[proofIndex];
            const proofArgs = (_g = event === null || event === void 0 ? void 0 : event.args) === null || _g === void 0 ? void 0 : _g.proof;
            ...
            if (isProofIndexValid[proofIndex] === undefined) {
                ...
                const proofIndexes = (_h = event === null || event === void 0 ? void 0 : event.args) === null || _h === void 0 ? void 0 : _h.proofIndexRecords.map((n) => Number(n));
