import { IncrementalMerkleTree, SparseMerkleTree, ZkIdentity } from '../crypto';
...
declare class UserState {
    ...
    signUp: (epoch: number, identityCommitment: BigInt, attesterId?: number | undefined, airdropAmount?: number | undefined, blockNumber?: number | undefined) => Promise<void>;
