...
exports.Unirep = exports.UnirepFactory = exports.getUnirepContract = exports.deployUnirep = exports.computeProcessAttestationsProofHash = exports.computeStartTransitionProofHash = exports.UserTransitionProof = exports.SignUpProof = exports.ReputationProof = exports.EpochKeyProof = exports.Attestation = exports.AttestationEvent = exports.Event = void 0;
const ethers_1 = require("ethers");
const crypto_1 = require("@unirep/crypto");
const circuits_1 = require("@unirep/circuits");
const config_1 = require("@unirep/config");
const typechain_1 = require("../typechain");
Object.defineProperty(exports, "Unirep", { enumerable: true, get: function () { return typechain_1.Unirep; } });
...
class UserTransitionProof {
    constructor(_publicSignals, _proof) {
        ...
        this.transitionFromEpoch =
            _publicSignals[1 + config_1.NUM_EPOCH_KEY_NONCE_PER_EPOCH];
        ...
        this.fromGlobalStateTree =
            _publicSignals[4 + config_1.NUM_EPOCH_KEY_NONCE_PER_EPOCH];
        for (let i = 0; i < config_1.NUM_EPOCH_KEY_NONCE_PER_EPOCH; i++) {
            this.blindedHashChains.push(_publicSignals[5 + config_1.NUM_EPOCH_KEY_NONCE_PER_EPOCH + i]);
        }
        this.fromEpochTree =
            _publicSignals[5 + config_1.NUM_EPOCH_KEY_NONCE_PER_EPOCH * 2];
        this.proof = formattedProof;
        this.publicSignals = _publicSignals;
    }
}
