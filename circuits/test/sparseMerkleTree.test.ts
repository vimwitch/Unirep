...
import { genRandomSalt, hashOne, SparseMerkleTree } from '@root/crypto'
...
const circuitPath = path.join(__dirname, './circuits/smtLeafExists_test.circom')
const InclusionProofCircuitPath = path.join(
    __dirname,
    './circuits/smtInclusionProof_test.circom'
)
